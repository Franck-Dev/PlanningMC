 ...
 */
final class Version20190827152131 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE type_recurrance ADD nbr_jour_cycle INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE type_recurrance DROP nbr_jour_cycle');
