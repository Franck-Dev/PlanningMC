 ...
 */
final class Version20201208150429 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chargement ADD programme VARCHAR(255) NOT NULL, CHANGE id_planning id_planning INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chargement DROP programme, CHANGE id_planning id_planning INT DEFAULT NULL');
