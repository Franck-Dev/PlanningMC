 ...
 */
final class Version20210401202103 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE charge DROP FOREIGN KEY FK_556BA4343D865311');
        $this->addSql('DROP INDEX IDX_556BA4343D865311 ON charge');
        $this->addSql('ALTER TABLE charge CHANGE planning_id polym_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE charge ADD CONSTRAINT FK_556BA4346F340C96 FOREIGN KEY (polym_id) REFERENCES polym_real (id)');
        $this->addSql('CREATE INDEX IDX_556BA4346F340C96 ON charge (polym_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE charge CHANGE polym_id planning_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE charge ADD CONSTRAINT FK_556BA4343D865311 FOREIGN KEY (planning_id) REFERENCES polym_real (id)');
        $this->addSql('CREATE INDEX IDX_556BA4343D865311 ON charge (planning_id)');
