 ...
 */
final class Version20200302133757 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE articles_outillages DROP FOREIGN KEY FK_97E58CE11EBAF6CC');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE articles (id INT AUTO_INCREMENT NOT NULL, reference INT NOT NULL, designation VARCHAR(30) NOT NULL COLLATE utf8mb4_unicode_ci, serie TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE prog_moyens_outillages (prog_moyens_id INT NOT NULL, outillages_id INT NOT NULL, INDEX IDX_EDC55E99C9ECABC3 (prog_moyens_id), INDEX IDX_EDC55E994D6CE55C (outillages_id), PRIMARY KEY(prog_moyens_id, outillages_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE articles_outillages ADD CONSTRAINT FK_97E58CE11EBAF6CC FOREIGN KEY (articles_id) REFERENCES articles (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE articles_outillages ADD CONSTRAINT FK_97E58CE14D6CE55C FOREIGN KEY (outillages_id) REFERENCES outillages (id) ON DELETE CASCADE');
