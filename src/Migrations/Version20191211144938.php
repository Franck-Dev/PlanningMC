 ...
 */
final class Version20191211144938 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE charge (id INT AUTO_INCREMENT NOT NULL, ordre_fab INT NOT NULL, poste_w INT NOT NULL, reference_pcs INT NOT NULL, designation_pcs VARCHAR(24) NOT NULL, num_prog VARCHAR(15) DEFAULT NULL, conf INT NOT NULL, date_deb_w DATETIME DEFAULT NULL, date_fin_w DATETIME DEFAULT NULL, date_creation DATETIME NOT NULL, statut VARCHAR(10) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
