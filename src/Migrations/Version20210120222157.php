 ...
 */
final class Version20210120222157 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE charge ADD date_pilote DATETIME NOT NULL');
        $this->addSql('ALTER TABLE chargement CHANGE id_planning id_planning INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE charge DROP date_pilote');
        $this->addSql('ALTER TABLE chargement CHANGE id_planning id_planning INT DEFAULT NULL');
