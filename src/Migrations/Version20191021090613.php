 ...
 */
final class Version20191021090613 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE polym_real ADD pourc_vol_charge SMALLINT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE polym_real DROP pourc_vol_charge');
